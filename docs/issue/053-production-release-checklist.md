# Issue 053: production 配備前チェックリストを作成する
...
production 配備前に確認するチェックリストを作成する。
...
- [ ] Rules / Indexes / Functions を先に配備したか確認する
- [ ] ロールバック対象バージョンを確認する
- [ ] 本番手動テスト結果を記録する
...
| No. | 操作 | 期待結果 | 結果 |
|---:|---|---|---|
| 1 | チェックリストを使って production Preview を確認する。 | 期待どおりに動作する | 未実施 |
