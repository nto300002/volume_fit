# Issue 006: Firestore Security Rules の初期構成を作成する
...
ユーザー分離を前提とした Security Rules の初期版を作る。
...
- [ ] 未認証ユーザーを拒否する
- [ ] 他ユーザーのデータを拒否する
- [ ] ownerUserId / createdAt / schemaVersion の不正変更を拒否する
...
| No. | 操作 | 期待結果 | 結果 |
|---:|---|---|---|
| 1 | Rules テストで許可系と拒否系を確認する。 | 期待どおりに動作する | 未実施 |
