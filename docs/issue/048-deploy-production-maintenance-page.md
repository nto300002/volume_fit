# Issue 048: production へメンテナンスページを初回配備する
...
アプリ機能公開前に production Hosting へ初期ページを配備する。
...
- [ ] production Hosting が有効である
- [ ] 一般公開ではなくメンテナンス表示にする
- [ ] production URL を確認する
...
| No. | 操作 | 期待結果 | 結果 |
|---:|---|---|---|
| 1 | production URL で初期ページが表示されることを確認する。 | 期待どおりに動作する | 未実施 |
