# Issue 050: staging Preview Channel へ配備できる
...
staging の Preview Channel にリリース候補を配備できる。
...
| No. | 操作 | 期待結果 | 結果 |
|---:|---|---|---|
| 1 | Preview URL で主要画面と Firebase 接続先を確認する。 | 期待どおりに動作する | 未実施 |
