# Issue 044: production Firebase プロジェクトを早期構築する
...
Web 基盤構築直後に production Firebase プロジェクトを作成する。
...
- [ ] Web アプリを登録する
- [ ] Authentication / Firestore / Hosting を初期化する
- [ ] 予算アラートと App Check 設定枠を用意する
...
| No. | 操作 | 期待結果 | 結果 |
|---:|---|---|---|
| 1 | production ビルドの接続先と本番データ制限を確認する。 | 期待どおりに動作する | 未実施 |
