# Issue 046: Firebase Hosting を 3 環境へ設定する
...
development / staging / production の Hosting を設定する。
...
- [ ] Preview Channel を利用できる
- [ ] live 配備先を環境ごとに分離する
- [ ] 直接 URL アクセスで SPA が動く
...
| No. | 操作 | 期待結果 | 結果 |
|---:|---|---|---|
| 1 | 各 Hosting URL で初期ページを確認する。 | 期待どおりに動作する | 未実施 |
