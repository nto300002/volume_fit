# Issue 043: staging Firebase プロジェクトを構築する
...
リリース候補検証用の Firebase プロジェクトを構築する。
...
| No. | 操作 | 期待結果 | 結果 |
|---:|---|---|---|
| 1 | staging ビルドが staging Firebase に接続することを確認する。 | 期待どおりに動作する | 未実施 |
