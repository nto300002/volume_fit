# Issue 005: Firebase Web 接続を構築する
...
Firebase Web アプリ設定を組み込み、Authentication と Firestore へ接続できる状態にする。
...
- [ ] 環境別 Firebase 設定を読み込める
- [ ] Authentication 初期化が成功する
- [ ] Firestore 初期化が成功する
...
| No. | 操作 | 期待結果 | 結果 |
|---:|---|---|---|
| 1 | Firebase Emulator または対象環境への接続を確認する。 | 期待どおりに動作する | 未実施 |
